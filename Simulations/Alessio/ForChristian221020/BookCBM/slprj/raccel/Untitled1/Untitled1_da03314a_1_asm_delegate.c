...
Untitled1_da03314a_1_resetAsmStateVector ( const void * mech , double * state
) { double xx [ 1 ] ; ( void ) mech ; xx [ 0 ] = 0.0 ; state [ 0 ] = xx [ 0 ]
; state [ 1 ] = xx [ 0 ] ; state [ 2 ] = xx [ 0 ] ; state [ 3 ] = xx [ 0 ] ;
} void Untitled1_da03314a_1_initializeTrackedAngleState ( const void * mech ,
...
; ( void ) motionData ; } void Untitled1_da03314a_1_computeDiscreteState (
...
void ) state ; } void Untitled1_da03314a_1_adjustPosition ( const void * mech
...
Untitled1_da03314a_1_computePosDofBlendMatrix ( const void * mech , size_t
...
primIdx ) ) { } } void Untitled1_da03314a_1_computeVelDofBlendMatrix ( const
...
Untitled1_da03314a_1_projectPartiallyTargetedPos ( const void * mech , size_t
stageIdx , size_t primIdx , const double * origState , int partialType ,
double * state ) { ( void ) mech ; ( void ) stageIdx ; ( void ) primIdx ; (
void ) origState ; ( void ) partialType ; ( void ) state ; switch ( (
stageIdx * 6 + primIdx ) ) { } } void Untitled1_da03314a_1_propagateMotion (
...
; xx [ 1 ] = 0.5 ; xx [ 2 ] = xx [ 1 ] * state [ 0 ] ; xx [ 3 ] = xx [ 0 ] *
sin ( xx [ 2 ] ) ; xx [ 4 ] = xx [ 0 ] * cos ( xx [ 2 ] ) ; xx [ 0 ] = 2.0 ;
xx [ 2 ] = 0.25 ; xx [ 5 ] = xx [ 2 ] * xx [ 4 ] ; xx [ 6 ] = xx [ 5 ] * xx [
3 ] ; xx [ 7 ] = xx [ 5 ] * xx [ 4 ] ; xx [ 5 ] = xx [ 1 ] * state [ 2 ] ; xx
[ 1 ] = cos ( xx [ 5 ] ) ; xx [ 8 ] = sin ( xx [ 5 ] ) ; xx [ 5 ] = 0.0 ; xx
[ 9 ] = xx [ 2 ] * xx [ 8 ] ; xx [ 10 ] = xx [ 0 ] * xx [ 9 ] * xx [ 1 ] ; xx
[ 11 ] = xx [ 2 ] - ( xx [ 0 ] * xx [ 9 ] * xx [ 8 ] - xx [ 2 ] ) ; xx [ 9 ]
= 0.2500000000000001 ; xx [ 12 ] = xx [ 9 ] * state [ 1 ] ; xx [ 13 ] = xx [
11 ] * state [ 1 ] + xx [ 12 ] ; xx [ 14 ] = xx [ 13 ] * xx [ 8 ] ; xx [ 15 ]
= xx [ 10 ] * state [ 1 ] ; xx [ 16 ] = xx [ 15 ] * xx [ 8 ] ; motionData [ 0
] = xx [ 3 ] ; motionData [ 1 ] = xx [ 4 ] ; motionData [ 2 ] = xx [ 4 ] ;
motionData [ 3 ] = xx [ 3 ] ; motionData [ 4 ] = xx [ 0 ] * ( xx [ 6 ] + xx [
6 ] ) ; motionData [ 5 ] = - ( xx [ 0 ] * ( xx [ 6 ] - xx [ 6 ] ) ) ;
motionData [ 6 ] = xx [ 2 ] - xx [ 0 ] * ( xx [ 7 ] + xx [ 7 ] ) ; motionData
[ 7 ] = xx [ 1 ] ; motionData [ 8 ] = - xx [ 8 ] ; motionData [ 9 ] = xx [ 5
] ; motionData [ 10 ] = xx [ 5 ] ; motionData [ 11 ] = xx [ 5 ] ; motionData
[ 12 ] = xx [ 10 ] ; motionData [ 13 ] = xx [ 11 ] ; motionData [ 14 ] = -
state [ 1 ] ; motionData [ 15 ] = xx [ 5 ] ; motionData [ 16 ] = xx [ 5 ] ;
motionData [ 17 ] = xx [ 5 ] ; motionData [ 18 ] = xx [ 12 ] ; motionData [
19 ] = xx [ 5 ] ; motionData [ 20 ] = - ( state [ 1 ] + state [ 3 ] ) ;
motionData [ 21 ] = xx [ 5 ] ; motionData [ 22 ] = xx [ 5 ] ; motionData [ 23
] = xx [ 5 ] ; motionData [ 24 ] = xx [ 13 ] - xx [ 0 ] * ( xx [ 14 ] * xx [
8 ] - xx [ 16 ] * xx [ 1 ] ) + xx [ 9 ] * state [ 3 ] ; motionData [ 25 ] =
xx [ 0 ] * ( xx [ 14 ] * xx [ 1 ] + xx [ 16 ] * xx [ 8 ] ) - xx [ 15 ] ; }
size_t Untitled1_da03314a_1_computeAssemblyError ( const void * mech , const
...
Untitled1_da03314a_1_computeAssemblyJacobian ( const void * mech , const
...
size_t Untitled1_da03314a_1_computeFullAssemblyJacobian ( const void * mech ,
...
Untitled1_da03314a_1_isInKinematicSingularity ( const void * mech , const
RuntimeDerivedValuesBundle * rtdv , size_t constraintIdx , const int *
modeVector , const double * motionData ) { ( void ) mech ; ( void ) rtdv ; (
void ) modeVector ; ( void ) motionData ; switch ( constraintIdx ) { } return
0 ; } void Untitled1_da03314a_1_convertStateVector ( const void * asmMech ,
