...
void Untitled1_da03314a_1_resetSimStateVector ( const void * mech , double *
...
} void Untitled1_da03314a_1_constructStateVector ( const void * mech , const
...
fullState [ 3 ] = solverState [ 3 ] ; } void
Untitled1_da03314a_1_extractSolverStateVector ( const void * mech , const
double * fullState , double * solverState ) { ( void ) mech ; solverState [ 0
] = fullState [ 0 ] ; solverState [ 1 ] = fullState [ 1 ] ; solverState [ 2 ]
= fullState [ 2 ] ; solverState [ 3 ] = fullState [ 3 ] ; } boolean_T
Untitled1_da03314a_1_isPositionViolation ( const void * mech , const
...
Untitled1_da03314a_1_projectStateSim ( const void * mech , const
...
void Untitled1_da03314a_1_computeConstraintError ( const void * mech , const
...
) error ; } void Untitled1_da03314a_1_resetModeVector ( const void * mech ,
int * modeVector ) { ( void ) mech ; ( void ) modeVector ; } boolean_T
Untitled1_da03314a_1_hasJointDisToNormModeChange ( const void * mech , const
...
; return NULL ; } void Untitled1_da03314a_1_onModeChangedCutJoints ( const
