...
Untitled1_da03314a_1_assertData [ ] ; extern const NeZCData
Untitled1_da03314a_1_ZCData [ ] ; void
Untitled1_da03314a_1_computeRuntimeParameters ( const double *
runtimeRootVariables , double * runtimeParameters ) ; void
Untitled1_da03314a_1_validateRuntimeParameters ( const double *
runtimeParameters , int32_T * assertSatisfactionFlags ) ; void
Untitled1_da03314a_1_computeAsmRuntimeDerivedValues ( const double *
runtimeParameters , RuntimeDerivedValuesBundle * runtimeDerivedValuesBundle )
; void Untitled1_da03314a_1_computeSimRuntimeDerivedValues ( const double *
runtimeParameters , RuntimeDerivedValuesBundle * runtimeDerivedValuesBundle )
; void Untitled1_da03314a_1_initializeGeometries ( const
RuntimeDerivedValuesBundle * runtimeDerivedValuesBundle ) ; PmfMessageId
Untitled1_da03314a_1_compDerivs ( const RuntimeDerivedValuesBundle * , const
int * , const double * , const int * , const double * , const double * ,
const double * , const double * , double * , double * , NeuDiagnosticManager
* neDiagMgr ) ; PmfMessageId Untitled1_da03314a_1_numJacPerturbLoBounds (
...
Untitled1_da03314a_1_numJacPerturbHiBounds ( const RuntimeDerivedValuesBundle
...
Untitled1_da03314a_1_checkDynamics ( const RuntimeDerivedValuesBundle * ,
const double * , const double * , const double * , const double * , const
double * , const int * , double * , NeuDiagnosticManager * neDiagMgr ) ;
PmfMessageId Untitled1_da03314a_1_compOutputsDyn ( const
...
PmfMessageId Untitled1_da03314a_1_compOutputsKin ( const
RuntimeDerivedValuesBundle * , const double * , const int * , const double *
, const double * , const double * , const double * , double * ,
NeuDiagnosticManager * neDiagMgr ) ; PmfMessageId
Untitled1_da03314a_1_compOutputs ( const RuntimeDerivedValuesBundle * , const
double * , const int * , const double * , const double * , const double * ,
const double * , double * , NeuDiagnosticManager * neDiagMgr ) ; PmfMessageId
Untitled1_da03314a_1_computeAsmModeVector ( const double * , const double * ,
const double * , int * , double * , NeuDiagnosticManager * neDiagMgr ) ;
PmfMessageId Untitled1_da03314a_1_computeSimModeVector ( const double * ,
const double * , const double * , int * , double * , NeuDiagnosticManager *
neDiagMgr ) ; PmfMessageId Untitled1_da03314a_1_computeZeroCrossings ( const
RuntimeDerivedValuesBundle * , const double * , const double * , const double
* , const double * , const double * , double * , double * ,
NeuDiagnosticManager * neDiagMgr ) ; PmfMessageId
Untitled1_da03314a_1_recordLog ( const RuntimeDerivedValuesBundle * , const
int * , const double * , const int * , const double * , const double * ,
const double * , double * , double * , NeuDiagnosticManager * neDiagMgr ) ;
void Untitled1_da03314a_1_setTargets ( const RuntimeDerivedValuesBundle *
runtimeDerivedValuesBundle , CTarget * targets ) ; void
Untitled1_da03314a_1_resetAsmStateVector ( const void * mech , double *
stateVector ) ; void Untitled1_da03314a_1_resetSimStateVector ( const void *
mech , double * stateVector ) ; void
Untitled1_da03314a_1_initializeTrackedAngleState ( const void * mech , const
...
error ) ; size_t Untitled1_da03314a_1_computeAssemblyJacobian ( const void *
...
) ; size_t Untitled1_da03314a_1_computeFullAssemblyJacobian ( const void *
...
double * J ) ; boolean_T Untitled1_da03314a_1_isInKinematicSingularity (
const void * mech , const RuntimeDerivedValuesBundle *
runtimeDerivedValuesBundle , size_t constraintIdx , const int * modeVector ,
const double * motionData ) ; void Untitled1_da03314a_1_convertStateVector (
...
Untitled1_da03314a_1_computeConstraintError ( const void * mech , const
RuntimeDerivedValuesBundle * runtimeDerivedValuesBundle , const double *
stateVector , const int * modeVector , double * error ) ; void
Untitled1_da03314a_1_resetModeVector ( const void * mech , int * modeVector )
; boolean_T Untitled1_da03314a_1_hasJointDisToNormModeChange ( const void *
mech , const int * prevModeVector , const int * modeVector ) ; PmfMessageId
Untitled1_da03314a_1_performJointDisToNormModeChange ( const void * mech ,
...
neDiagMgr ) ; void Untitled1_da03314a_1_onModeChangedCutJoints ( const void *
mech , const int * prevModeVector , const int * modeVector , double *
stateVector ) ; PmfMessageId Untitled1_da03314a_1_assemble ( const double * u
...
return ; Untitled1_da03314a_1_computeRuntimeParameters ( runtimeRootVariables
, smData -> mRuntimeParameterScalars . mX ) ;
Untitled1_da03314a_1_computeAsmRuntimeDerivedValues ( smData ->
mRuntimeParameterScalars . mX , & dae -> mPrivateData ->
mAsmRuntimeDerivedValuesBundle ) ;
Untitled1_da03314a_1_computeSimRuntimeDerivedValues ( smData ->
mRuntimeParameterScalars . mX , & dae -> mPrivateData ->
mSimRuntimeDerivedValuesBundle ) ; Untitled1_da03314a_1_initializeGeometries
...
; Untitled1_da03314a_1_validateRuntimeParameters ( runtimeParams ,
...
Untitled1_da03314a_1_compDerivs ( & smData -> mSimRuntimeDerivedValuesBundle
, smData -> mSimulationDelegate . mRunTimeEnabledEquations . mValues ,
systemInput -> mX . mX , systemInput -> mM . mX , systemInput -> mU . mX ,
systemInput -> mU . mX + 1 , systemInput -> mV . mX + 1 , systemInput -> mD .
...
errorResult = 0.0 ; errorId = Untitled1_da03314a_1_numJacPerturbLoBounds ( &
...
mM . mX , systemInput -> mU . mX , systemInput -> mU . mX + 1 , systemInput
-> mV . mX + 1 , systemInput -> mD . mX , daeMethodOutput -> mNUMJAC_DX_LO .
...
Untitled1_da03314a_1_numJacPerturbHiBounds ( & smData ->
mSimRuntimeDerivedValuesBundle , smData -> mSimulationDelegate .
mRunTimeEnabledEquations . mValues , systemInput -> mX . mX , systemInput ->
mM . mX , systemInput -> mU . mX , systemInput -> mU . mX + 1 , systemInput
-> mV . mX + 1 , systemInput -> mD . mX , daeMethodOutput -> mNUMJAC_DX_HI .
mX , & errorResult , neDiagMgr ) ; return errorId ; } static PmfMessageId
...
-> mPrivateData ; errorId = Untitled1_da03314a_1_compOutputs ( & smData ->
mSimRuntimeDerivedValuesBundle , systemInput -> mX . mX , systemInput -> mM .
mX , systemInput -> mU . mX , systemInput -> mU . mX + 1 , systemInput -> mV
. mX + 1 , systemInput -> mD . mX , daeMethodOutput -> mY . mX , neDiagMgr )
...
errorId = Untitled1_da03314a_1_computeSimModeVector ( systemInput -> mU . mX
, systemInput -> mU . mX + 1 , systemInput -> mV . mX + 1 , daeMethodOutput
...
Untitled1_da03314a_1_computeZeroCrossings ( & smData ->
...
Untitled1_da03314a_1_constructStateVector ( NULL , systemInput -> mX . mX ,
systemInput -> mU . mX , systemInput -> mU . mX + 1 , systemInput -> mD . mX
, fullStateVector ) ; errorId = Untitled1_da03314a_1_recordLog ( & smData ->
mSimRuntimeDerivedValuesBundle , smData -> mSimulationDelegate .
mRunTimeEnabledEquations . mValues , fullStateVector , systemInput -> mM . mX
, systemInput -> mU . mX , systemInput -> mU . mX + 1 , systemInput -> mV .
mX + 1 , output -> mX , & errorResult , neDiagMgr ) ; return errorId ; }
...
mX , systemInput -> mU . mX + 1 , systemInput -> mD . mX , systemInput -> mX
...
Untitled1_da03314a_1_checkDynamics ( & smData ->
mSimRuntimeDerivedValuesBundle , systemInput -> mX . mX , systemInput -> mU .
mX , systemInput -> mU . mX + 1 , systemInput -> mV . mX + 1 , systemInput ->
...
Untitled1_da03314a_1_computeSimModeVector ( systemInput -> mU . mX ,
systemInput -> mU . mX + 1 , systemInput -> mV . mX + 1 , systemInput -> mM .
...
mSimulationDelegate , & smData -> mSimRuntimeDerivedValuesBundle ,
systemInput -> mM . mX , systemInput -> mU . mX , systemInput -> mU . mX + 1
...
size_t numTargets = 4 ; unsigned int asmStatus = 0 ; double *
...
Untitled1_da03314a_1_computeAsmModeVector ( systemInput -> mU . mX ,
systemInput -> mU . mX + 1 , systemInput -> mV . mX + 1 , smData ->
...
#if 0
Untitled1_da03314a_1_checkTargets ( & smData ->
...
mStateVectorSize = 4 ; smData -> mFullStateVectorSize = 4 ; smData ->
mDiscreteStateSize = 0 ; smData -> mModeVectorSize = 0 ; smData ->
mNumZeroCrossings = 0 ; smData -> mInputVectorSize = 1 ; smData ->
mOutputVectorSize = 2 ; smData -> mNumConstraintEqns = 0 ; for ( i = 0 ; i <
4 ; ++ i ) smData -> mChecksum [ i ] = 0 ; } static void initStateVector (
NeDaePrivateData * smData ) { PmAllocator * alloc = pm_default_allocator ( )
; const int32_T stateVectorMap [ 4 ] = { 0 , 1 , 2 , 3 } ; const CTarget
targets [ 4 ] = { { 0 , 11 , 0 , false , 0 , 2 , "deg" , false , true , +
1.000000000000000000e+00 , false , 1 , { + 3.490658503988658956e-01 , +
0.000000000000000000e+00 , + 0.000000000000000000e+00 , +
0.000000000000000000e+00 } , { + 0.000000000000000000e+00 } } , { 0 , 11 , 0
, false , 0 , 0 , "1" , true , true , + 1.000000000000000000e+00 , false , 1
, { + 0.000000000000000000e+00 , + 0.000000000000000000e+00 , +
0.000000000000000000e+00 , + 0.000000000000000000e+00 } , { +
0.000000000000000000e+00 } } , { 0 , 12 , 0 , false , 0 , 2 , "deg" , false ,
true , + 1.000000000000000000e+00 , false , 1 , { - 3.490658503988658956e-01
, + 0.000000000000000000e+00 , + 0.000000000000000000e+00 , +
0.000000000000000000e+00 } , { + 0.000000000000000000e+00 } } , { 0 , 12 , 0
, false , 0 , 0 , "1" , true , true , + 1.000000000000000000e+00 , false , 1
, { + 0.000000000000000000e+00 , + 0.000000000000000000e+00 , +
0.000000000000000000e+00 , + 0.000000000000000000e+00 } , { +
...
pm_default_allocator ( ) ; int_T status = 0 ; smData -> mNumParamAsserts = 2
...
Untitled1_da03314a_1_assertData ; size_t i ; PM_ALLOCATE_ARRAY ( smData ->
mParamAssertObjects , PmCharVector , 2 , alloc ) ; PM_ALLOCATE_ARRAY ( smData
-> mParamAssertPaths , PmCharVector , 2 , alloc ) ; PM_ALLOCATE_ARRAY (
smData -> mParamAssertDescriptors , PmCharVector , 2 , alloc ) ;
PM_ALLOCATE_ARRAY ( smData -> mParamAssertMessages , PmCharVector , 2 , alloc
) ; PM_ALLOCATE_ARRAY ( smData -> mParamAssertMessageIds , PmCharVector , 2 ,
...
Untitled1_da03314a_1_ZCData ; size_t i ; PM_ALLOCATE_ARRAY ( smData ->
...
[ 4 ] = { "Revolute_Joint.Rz.q" , "Revolute_Joint.Rz.w" ,
"Revolute_Joint1.Rz.q" , "Revolute_Joint1.Rz.w" } ; const char * varObjects [
4 ] = { "Untitled1/Revolute Joint" , "Untitled1/Revolute Joint" ,
"Untitled1/Revolute Joint1" , "Untitled1/Revolute Joint1" } ; smData ->
...
PmCharVector , 4 , alloc ) ; PM_ALLOCATE_ARRAY ( smData -> mVarObjects ,
PmCharVector , 4 , alloc ) ; for ( s = 0 ; s < smData -> mNumVarScalars ; ++
...
"RTP_027A0CB6_GravityVector" } ; smData -> mNumRtpRootVars = 1 ; status =
...
mAsmRuntimeDerivedValuesBundle , 3 , 0 ) ;
sm_core_RuntimeDerivedValuesBundle_create ( & smData ->
mSimRuntimeDerivedValuesBundle , 3 , 0 ) ; } static void initIoInfoHelper (
...
) { const char * inputPortPaths [ 1 ] = { "Revolute_Joint.ti" } ; const char
* inputUnits [ 1 ] = { "kg*m^2/s^2" } ; const SizePair inputDimensions [ 1 ]
= { { 1 , 1 } } ; const char * outputPortPaths [ 2 ] = { "Revolute_Joint.q" ,
"Revolute_Joint1.q" } ; const char * outputUnits [ 2 ] = { "rad" , "rad" } ;
const SizePair outputDimensions [ 2 ] = { { 1 , 1 } , { 1 , 1 } } ;
...
NeDaePrivateData * smData ) { const int32_T numInputDerivs [ 1 ] = { 0 } ;
...
smData ) { const boolean_T directFeedthroughVector [ 1 ] = { false } ; const
boolean_T directFeedthroughMatrix [ 2 ] = { false , false } ; PmAllocator *
...
pm_default_allocator ( ) ; const int32_T outputFunctionMap [ 2 ] = { 0 , 0 }
; smData -> mOutputFunctionMap = pm_create_int_vector ( 2 , alloc ) ; memcpy
...
jointToStageIdx [ 2 ] = { { 11 , 0 } , { 12 , 1 } } ; const size_t
...
) ; delegate -> mSetTargets = Untitled1_da03314a_1_setTargets ; delegate ->
mResetStateVector = Untitled1_da03314a_1_resetAsmStateVector ; delegate ->
mInitializeTrackedAngleState =
Untitled1_da03314a_1_initializeTrackedAngleState ; delegate ->
mComputeDiscreteState = Untitled1_da03314a_1_computeDiscreteState ; delegate
-> mAdjustPosition = Untitled1_da03314a_1_adjustPosition ; delegate ->
mPerturbJointPrimitiveState =
Untitled1_da03314a_1_perturbAsmJointPrimitiveState ; delegate ->
mPerturbFlexibleBodyState = NULL ; delegate -> mComputePosDofBlendMatrix =
Untitled1_da03314a_1_computePosDofBlendMatrix ; delegate ->
mComputeVelDofBlendMatrix = Untitled1_da03314a_1_computeVelDofBlendMatrix ;
delegate -> mProjectPartiallyTargetedPos =
Untitled1_da03314a_1_projectPartiallyTargetedPos ; delegate ->
mPropagateMotion = Untitled1_da03314a_1_propagateMotion ; delegate ->
mComputeAssemblyError = Untitled1_da03314a_1_computeAssemblyError ; delegate
-> mComputeAssemblyJacobian = Untitled1_da03314a_1_computeAssemblyJacobian ;
delegate -> mComputeFullAssemblyJacobian =
Untitled1_da03314a_1_computeFullAssemblyJacobian ; delegate ->
mIsInKinematicSingularity = Untitled1_da03314a_1_isInKinematicSingularity ;
delegate -> mConvertStateVector = Untitled1_da03314a_1_convertStateVector ;
...
= NULL ; const SmSizePair jointToStageIdx [ 2 ] = { { 11 , 0 } , { 12 , 1 } }
...
Untitled1_da03314a_1_resetSimStateVector ; delegate ->
mInitializeTrackedAngleState = NULL ; delegate -> mComputeDiscreteState =
NULL ; delegate -> mAdjustPosition = NULL ; delegate ->
mPerturbJointPrimitiveState =
Untitled1_da03314a_1_perturbSimJointPrimitiveState ; delegate ->
mPerturbFlexibleBodyState = Untitled1_da03314a_1_perturbFlexibleBodyState ;
...
delegate -> mConstructStateVector = Untitled1_da03314a_1_constructStateVector
; delegate -> mExtractSolverStateVector =
Untitled1_da03314a_1_extractSolverStateVector ; delegate ->
mIsPositionViolation = Untitled1_da03314a_1_isPositionViolation ; delegate ->
mIsVelocityViolation = Untitled1_da03314a_1_isVelocityViolation ; delegate ->
mProjectStateSim = Untitled1_da03314a_1_projectStateSim ; delegate ->
mComputeConstraintError = Untitled1_da03314a_1_computeConstraintError ;
delegate -> mResetModeVector = Untitled1_da03314a_1_resetModeVector ;
delegate -> mHasJointDisToNormModeChange =
Untitled1_da03314a_1_hasJointDisToNormModeChange ; delegate ->
mPerformJointDisToNormModeChange =
Untitled1_da03314a_1_performJointDisToNormModeChange ; delegate ->
mOnModeChangedCutJoints = Untitled1_da03314a_1_onModeChangedCutJoints ;
...
} void Untitled1_da03314a_1_NeDaePrivateData_create ( NeDaePrivateData *
